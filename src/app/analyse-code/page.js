...
import {
  ISSUE_TYPES,
  ANALYSE_HOW_IT_WORKS,
  ANALYSE_WHAT_WE_CHECK,
} from "@/constants";
      ...
      {!reviewResult && (
        <>
          ...
          <div className="border-b border-gray-100">
            <div className="container mx-auto px-4 py-12 max-w-5xl text-center">
              ...
              <p className="text-lg text-gray-500 max-w-xl mx-auto">
                Paste a snippet or upload a file and get a detailed quality
                report — bugs, security issues, and recommendations in seconds.
              </p>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 py-10 max-w-5xl">
            <div className="grid sm:grid-cols-3 gap-0 mb-10">
              {ANALYSE_HOW_IT_WORKS.map((item, idx) => (
                <div
                  key={item.step}
                  className="relative flex flex-col items-center text-center px-6"
                >
                  {/* Connector line */}
                  {idx < ANALYSE_HOW_IT_WORKS.length - 1 && (
                    <div className="hidden sm:block absolute top-10 left-[calc(50%+40px)] right-0 h-px border-t-2 border-dashed border-gray-200 z-0" />
                  )}

                  {/* Icon */}
                  <div className="relative z-10 mb-4">
                    <div
                      className={`w-20 h-20 ${item.bg} rounded-2xl flex items-center justify-center mx-auto`}
                    >
                      <FeatureIcon
                        icon={item.icon}
                        size={28}
                    ...
                    <div
                      className={`absolute -top-2 -right-2 w-6 h-6 bg-gray-800 text-white rounded-full flex items-center justify-center text-xs font-bold`}
                    >
                      {item.step}
                    </div>
                  </div>
            ...
            <div className="grid lg:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col gap-4">
                ...
                <Card
                  border={false}
                  className="border border-gray-100 bg-gradient-to-br from-blue-50 to-purple-50"
                >
                  <div className="text-sm text-gray-600 space-y-2">
                    ...
                    <ul className="space-y-1.5 text-xs text-gray-500">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-blue-400 mt-0.5">•</span>
                        Avoid redacting variable names — they help the AI
                        understand logic.
                      </li>
                    </ul>
                  </div>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-0.5">
                Here's what we found in your code
              </p>
            </div>
            <Button variant="outline" size="small" onClick={resetReview}>
              New Analysis
          ...
          >
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 px-6 py-5 flex items-center justify-between">
              ...
              <div className="text-center">
                <div
                  className={`text-5xl font-bold ${getScoreColor(reviewResult.score)}`}
                >
                  {reviewResult.score}
                </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 divide-x divide-y sm:divide-y-0 divide-gray-100">
              {[
                ...
                {
                  label: "Lines",
                  value: reviewResult.linesAnalyzed ?? 0,
                  icon: "code",
          ...
          {reviewResult.analysis?.review && (
            <Card
              ...
              className="border border-gray-100"
              title="AI Review"
              subtitle="Detailed analysis from the model"
            >
